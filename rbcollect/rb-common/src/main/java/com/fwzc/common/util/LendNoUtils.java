...
public class LendNoUtils {
    ...
    public static String getRbDealItemNo() {

        return "RbDealItem" + getNo();
    }

    public static String getGoodsDealItemNo() {

        return "GoodsDealItem" + getNo();
    }
